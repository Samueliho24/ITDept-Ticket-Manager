...
from BackEnd.app.schemas.pagination import AuditLogPaginated
...
def list_audit_logs_endpoint(
    ...
    items, total = get_audit_logs_paginated(
        db, limit, offset, start_date, end_date, username_query, action_filter,
    )
    return AuditLogPaginated(total=total, limit=limit, offset=offset, items=items)
